...
private:
	float m_head_alignment = 0;
	float m_head_alignment2 = 0;
	float m_head_left_warning = 0;
	float m_head_middle_warning = 0;
	float m_head_right_warning = 0;
	float m_end_left_alignment = 0;
	float m_end_middle_alignment = 0;
	float m_end_right_alignment = 0;
	float m_end_left_warning = 0;
	float m_end_middle_warning = 0;
	...
	float m_end_left_alignment3 = 0;
	float m_end_right_alignment3 = 0;
signals:
